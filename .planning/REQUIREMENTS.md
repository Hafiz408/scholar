...
- [x] **EVAL-02**: Real RAGAS benchmark run with OpenStax Biology 2e; JSON results committed to `eval/results/`
- [x] **EVAL-03**: README comparison table updated with real faithfulness, answer relevancy, context precision, and avg latency scores
